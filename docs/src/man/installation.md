...
[Fibonacci](https://github.com/singularitti/Fibonacci.jl).
...
version of Fibonacci, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/singularitti/Fibonacci.jl"
```
...
our [GitHub repository](https://github.com/singularitti/Fibonacci.jl)
for new releases.
Once we release a new version, you can update Fibonacci by typing

```@repl
using Pkg
Pkg.update("Fibonacci")
Pkg.gc()
```
